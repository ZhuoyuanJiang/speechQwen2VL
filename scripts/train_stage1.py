"""
Stage 1 Training: Audio Projector Only (Multi-GPU DDP)

Trains the randomly initialized audio_projector (~17M params) to map Whisper
audio embeddings into the LLM's text embedding space. All other weights frozen.

Usage:
    python scripts/train_stage1.py              # auto-detect idle GPUs, launch DDP
    python scripts/train_stage1.py --nproc 4    # use at most 4 GPUs
    CUDA_VISIBLE_DEVICES=0,1 python scripts/train_stage1.py  # manual GPU selection
"""
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str,
                        default="./checkpoints/stage1_audio_projector")
    ...
    parser.add_argument("--eval_batch_size", type=int, default=2,
                        help="Per-device eval batch size (default: 2, independent of train batch)")
...
training_args = TrainingArguments(
    ...
    per_device_eval_batch_size=args.eval_batch_size,  # explicit — HF defaults to 8 which can OOM
